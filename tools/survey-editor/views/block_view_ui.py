...
class Ui_Block(object):
    def setupUi(self, Block):
        ...
        self.gridLayout_2.addWidget(self.plainTextEdit, 13, 0, 1, 1)
    ...
    def retranslateUi(self, Block):
        ...
        self.pushButton.setText(_translate("Block", "previous"))
        self.pushButton_2.setText(_translate("Block", "back to days"))
        self.pushButton_3.setText(_translate("Block", "next"))
