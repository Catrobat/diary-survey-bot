...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.name_field = QtWidgets.QFrame(Settings)
        self.name_field.setMinimumSize(QtCore.QSize(320, 0))
        self.name_field.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        self.name_field.setFont(font)
        self.name_field.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.name_field.setFrameShadow(QtWidgets.QFrame.Raised)
        self.name_field.setObjectName("name_field")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.name_field)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout()
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.name_headline = QtWidgets.QLabel(self.name_field)
        ...
        self.time_field_3 = QtWidgets.QLineEdit(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        self.time_field_3.setFont(font)
        self.time_field_3.setText("")
        self.time_field_3.setReadOnly(True)
        self.time_field_3.setPlaceholderText("")
        self.time_field_3.setObjectName("time_field_3")
        self.horizontalLayout.addWidget(self.time_field_3)
        self.verticalLayout_2.addLayout(self.horizontalLayout)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.language_headline = QtWidgets.QLabel(self.name_field)
        ...
        self.language_field = QtWidgets.QLineEdit(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.language_box = QtWidgets.QComboBox(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.editor_headline = QtWidgets.QLabel(self.name_field)
        ...
        self.editor_field = QtWidgets.QLineEdit(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.editor_box = QtWidgets.QComboBox(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        self.editor_box.setFont(font)
        self.editor_box.setCurrentText("")
        ...
        self.custom_headline = QtWidgets.QLabel(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.custom_field = QtWidgets.QLineEdit(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.custom_field.setReadOnly(True)
        ...
        self.custom_add_button = QtWidgets.QPushButton(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.custom_list = QtWidgets.QListWidget(self.name_field)
        ...
        self.custom_delete_button = QtWidgets.QPushButton(self.name_field)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.save_button = QtWidgets.QPushButton(self.name_field)
        self.save_button.setObjectName("save_button")
        self.gridLayout_2.addWidget(self.save_button, 3, 1, 1, 1)
        self.gridLayout_4.addWidget(self.name_field, 2, 0, 1, 1)
